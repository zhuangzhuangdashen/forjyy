package juctest.readwritelocktest;
    ...
    public void getCash() {
        new Thread() {
            public void run() {
                ...
                try {
                    System.out.println(Thread.currentThread().getName() + " getCrash start");
                    myCount.getCash();
                    Thread.sleep(1000);
                    System.out.println(Thread.currentThread().getName() + " getCrash end");
                } catch (Exception e) {
                }finally {
